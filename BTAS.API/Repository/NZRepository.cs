...
{
    public class NZRepository
    {
        private readonly MainDbContext _context;
        private IMapper _mapper;
        private IAustwayLabelRepository repo;

        public NZRepository(MainDbContext context, IMapper mapper, IAustwayLabelRepository repo)
        {
            _context = context;
            _mapper = mapper;
            this.repo = repo;
        ...
        //    try
        //    {
        //        var routing = _context.tbl_nz_routings
        ...
        //            };
        //        }
        //        var consignment = new tbl_tracking_nz
        //        {
        ...
        //        };
        //        _context.tbl_tracking_nzs.Add(consignment);
        //        await _context.SaveChangesAsync();

        //        int i = 0;
        //        foreach (var item in items)
        //        {
        //            string tracking = "MYP" + String.Format("{0:000000000}", consignment.tbl_tracking_id) + String.Format("{0:0000}", i+1);
        ...
        //            items[i].Consignment = "MYP" + String.Format("{0:00000000}", consignment.tbl_tracking_id);

        //            i++;
        //        }

        //        return await repo.GenerateLabelAsync("NZ Post Truck", items, recipient, shipper);
        //    }
        //    catch (Exception ex)
        //    {
        //        return new CreateLabelResponse
