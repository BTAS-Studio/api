...
namespace BTAS.Data.Migrations
{
    ...
    [Migration("20230711053731_ChCcdAddrFK")]
    partial class ChCcdAddrFK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_address", b =>
                {
                    ...
                    b.Property<byte?>("tbl_address_isLegalEntity")
                        .HasColumnType("tinyint(1) unsigned");
                    ...
                    b.HasIndex("ClientContactDetailCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_document", b =>
                {
                    ...
                    b.HasIndex(new[] { "tbl_shipment_id" }, "idx_document_shipment_link_idx");
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_house", b =>
                {
                    ...
                    b.HasIndex(new[] { "tbl_incoterm_id" }, "FK_tbl_house_tbl_incoterm_tbl_incoterm_id_idx");

                    b.HasIndex(new[] { "tbl_deliveryClient_id" }, "IX_tbl_house_tbl_client_header_tbl_deliveryClient_id");

                    b.HasIndex(new[] { "tbl_pickupClient_id" }, "IX_tbl_house_tbl_client_header_tbl_pickClient_id");
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_note", b =>
                {
                    ...
                    b.HasIndex(new[] { "tbl_master_id" }, "idx_note_master_link_idx");

                    b.HasIndex(new[] { "tbl_note_category_id" }, "idx_note_note_category_link_idx");

                    b.HasIndex(new[] { "tbl_shipment_id" }, "idx_note_shipment_link_idx");
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_address", b =>
                {
                    b.HasOne("BTAS.Data.Models.tbl_client_contact_detail", "contactDetail")
                        ...
                        .HasPrincipalKey("BTAS.Data.Models.tbl_client_contact_detail", "tbl_client_contact_details_code")
                        .HasConstraintName("FK_contactDetail_address_ClientContactDeatilCode");
                    ...
                    b.HasOne("BTAS.Data.Models.tbl_client_header", "clientHeader")
                        ...
                        .HasConstraintName("FK_table_address_tbl_client_header_code");
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_house", b =>
                {
                    ...
                    b.HasOne("BTAS.Data.Models.tbl_client_contact_detail", "deliveryClientDetail")
                        .WithMany("deliveryHouses")
                        .HasForeignKey("tbl_deliveryClient_id")
                        .HasConstraintName("FK_tbl_house_tbl_client_contact_detail_tbl_deliveryClient_id");
                    ...
                    b.HasOne("BTAS.Data.Models.tbl_client_contact_detail", "pickupClientDetail")
                        .WithMany("pickupHouses")
                        .HasForeignKey("tbl_pickupClient_id")
                        .HasConstraintName("FK_tbl_house_tbl_client_contact_detail_tbl_pickupClient_id");
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_client_contact_detail", b =>
                {
                    ...
                    b.Navigation("deliveryHouses");

                    b.Navigation("pickupHouses");
                });
