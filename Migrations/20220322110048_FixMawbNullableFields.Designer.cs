...
namespace BTAS.Data.Migrations
{
    ...
    [Migration("20220322110048_FixMawbNullableFields")]
    partial class FixMawbNullableFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_mawb", b =>
                {
                    ...
                    b.HasIndex("tbl_client_header_carrier_id");

                    b.HasIndex("tbl_client_header_creditor_id");

                    b.HasIndex("tbl_client_header_destination_id");

                    b.HasIndex("tbl_client_header_origin_id");
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_parcel_info", b =>
                {
                    ...
                    b.Property<bool?>("tbl_parcel_info_authorityToLeave")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool?>("tbl_parcel_info_dg")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool?>("tbl_parcel_info_gstexemptioncode")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool?>("tbl_parcel_info_lockerService")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<bool?>("tbl_parcel_info_tailLiftD")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool?>("tbl_parcel_info_tailLiftO")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_parcel_items", b =>
                {
                    ...
                    b.Property<int?>("tbl_parcel_info_id")
                        .HasColumnType("int");

                    b.Property<bool?>("tbl_parcel_items_parcelDangerousGoods")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_mawb", b =>
                {
                    b.HasOne("BTAS.Data.Models.tbl_client_header", "carrierHeader")
                        .WithMany()
                        .HasForeignKey("tbl_client_header_carrier_id");

                    b.HasOne("BTAS.Data.Models.tbl_client_header", "creditorHeader")
                        .WithMany()
                        .HasForeignKey("tbl_client_header_creditor_id");

                    b.HasOne("BTAS.Data.Models.tbl_client_header", "destinationHeader")
                        .WithMany()
                        .HasForeignKey("tbl_client_header_destination_id");

                    b.HasOne("BTAS.Data.Models.tbl_client_header", "originHeader")
                        .WithMany()
                        .HasForeignKey("tbl_client_header_origin_id");

                    b.Navigation("carrierHeader");

                    b.Navigation("creditorHeader");

                    b.Navigation("destinationHeader");

                    b.Navigation("originHeader");
                });
            ...
            modelBuilder.Entity("BTAS.Data.Models.tbl_parcel_items", b =>
                {
                    ...
                    b.HasOne("BTAS.Data.Models.tbl_parcel_info", "parcelInfo")
                        .WithMany("parcelItems")
                        .HasForeignKey("tbl_parcel_info_id");
